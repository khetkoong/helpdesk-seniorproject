        ...
        <div class="app-main">
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>หน้าแก้ไขข้อมูลการแจ้งซ่อม
                                    <div class="page-title-subheading">หน้าแก้ไขข้อมูลการแจ้งซ่อม ที่ผู้ใช้สามารถแก้ไขได้
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php $room = $_POST['room']; ?>
                    <?php $item = $_POST['item']; ?>
                    <?php $serial_num = $_POST['serial_num']; ?>
                    <?php $detail = $_POST['detail']; ?>
                    
                    <hr />
                    <br />
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                        <h5 class="card-title">แก้ไขข้อมูลแจ้งซ่อม</h5>
                            <hr />
                            <form name="frmlogin" method="post" action="edit.php">
                            <div class="position-relative row form-group"><label for="exampleSelect" class="col-sm-2 col-form-label">ห้อง : </label>
                                    <div class="col-sm-10">
                                        <select name="room" from="frmlogin" required class="form-control">
                                            <option selected value > <?php echo "$room"; ?> </option>
                                            <?php
                                ...
                                <div class="position-relative row form-group"><label for="exampleSelect" class="col-sm-2 col-form-label">สิ่งของ : </label>
                                    <div class="col-sm-10">
                                        <select name="item" from="frmlogin" required class="form-control">
                                            <option selected value> <?php echo "$item"; ?> </option>
                                            <?php
                                ...
                                <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">เลขครุภัณฑ์ : </label>
                                    <div class="col-sm-10"><input name="serial_num" required id="exampleEmail" placeholder="เลขครุภัณฑ์" type="text" class="form-control" value="<?php echo "$serial_num" ?>"></div>
                                </div>
                                <div class="position-relative row form-group"><label for="exampleText" class="col-sm-2 col-form-label">รายละเอียด : </label>
                                    <div class="col-sm-10"><textarea name="detail" required id="exampleText" class="form-control"><?php echo "$detail" ?></textarea></div>
                                </div>

                                <input type='hidden' name='id' value='<?php echo "$id" ?>'>
                                <div class="position-relative row form-check">
                                    <div class="offset-sm-2">
                                        <button class="mb-2 mr-2 btn btn-success">ยืนยัน</button>
                                        <button class="mb-2 mr-2 btn btn-primary" onclick="history.back()">ย้อนกลับ</button>
                                    </div>
                                </div>
                            </form>
                        </div>
