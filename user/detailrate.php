            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">การแจ้งซ่อมที่ยังไม่ได้รับการประเมิณ</h5>
                            <?php
                            $id = $_SESSION['id'];
                            $name = $_SESSION['name'];
                            $sql = "SELECT * FROM ticket WHERE `user_id` = '$id' AND job_status= 'success' AND isRate = '0' ";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <button type='button' aria-haspopup='true' aria-expanded='false' data-toggle='dropdown' class='dropdown-toggle btn btn-danger'>ประเมิน</button>
                                    <div tabindex='-1' role='menu' aria-hidden='true' class='dropdown-menu'>

                                        <form action='form_rate.php' method='post'>
                                            <input type='hidden' name='id' value='" . $row['id'] . "'>
                                            <button type='submit' tabindex='0' class='dropdown-item'>ประเมิน</button>
                                        </form>
