            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>หน้าแสดงการแจ้งซ่อมที่ได้รับการแก้ไขแล้ว
                                    <div class="page-title-subheading">หน้าแสดงการแจ้งซ่อมต่างๆ ที่ได้รับการแก้ไขจากพนักงานซ่อมแล้ว
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">ปัญหาที่ได้รับการแก้ไขแล้ว</h5>
                            <?php
                            $id = $_SESSION['id'];
                            $name = $_SESSION['name'];
                            $sql = "SELECT id, room, item, detail, job_status FROM ticket WHERE `user_id` = '$id' AND job_status= 'success'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "ยังไม่มีการซ่อมสถานะ Success <br />";
