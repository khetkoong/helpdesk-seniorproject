            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>การแจ้งซ่อมที่เสร็จสิ้น
                                    <div class="page-title-subheading">หน้างานที่เสร็จแล้วจะแสดงการแจ้งซ่อมที่เป็นสถานะ ซ่อมเสร็จแล้ว
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                        <h5 class="card-title">การแจ้งซ่อมที่เสร็จสิ้น</h5>
                            <?php
